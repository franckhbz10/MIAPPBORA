...
class HuggingFaceAdapter:
    ...
    def _initialize_models(self):
        ...
        try:
            ...
            # Inicializar cliente de inferencia para LLM
            if settings.HUGGINGFACE_API_KEY:
                ...
                logger.warning(
                    "No se configuró HUGGINGFACE_API_KEY. "
                    "Usando API pública con límites de rate."
                )
                self.inference_client = InferenceClient()
    ...
    def chat_completion(
        ...
        try:
            ...
            response = self.generate_text(prompt, max_length=max_tokens)
            return response
